...
var _singleEs6Js = require("../js/development/after-libs/single.es6.js");
var _templateReelEs6Js = require("../js/development/after-libs/template-reel.es6.js");

},{"./styles.scss":"kMfPY","../js/development/after-libs/work.es6.js":"g99Ty","../js/development/after-libs/modal.js":"5VGW5","../js/development/after-libs/pw-protection.js":"gEGzy","../js/development/after-libs/single.es6.js":"1hdsC","../js/development/after-libs/template-reel.es6.js":"3m4Rp"}],"kMfPY":[function() {},{}],"g99Ty":[function(require,module,exports) {
...
if (elms.length) for(var i = 0; i < elms.length; i++){
    ...
    $(window).on("scroll", function() {
        if (splide.state.is(Splide.STATES.IDLE)) return;
        if (isInViewport(currentItem)) splide_init(splide);
    });
...
parcelHelpers.export(exports, "HoverSlider", ()=>HoverSlider);
function HoverSlider(Splide, Components, options) {
    /**
...
},{}],"5VGW5":[function(require,module,exports) {
$(function() {
    if ($(".modal").length) {
        ...
        function prev() {
            ...
            muteAllVideos();
            $(".modal__image").removeClass("modal__image--active");
            if ($(activeItem).is(":first-child")) $(".modal__image").last().addClass("modal__image--active");
            else $(activeItem).prev().addClass("modal__image--active");
...
},{}],"gEGzy":[function(require,module,exports) {
$(function() {
...
},{}],"1hdsC":[function(require,module,exports) {
if (document.body.classList.contains("single")) {
    ...
    function workSingleStickiness() {
        ...
        if (scrollPos > workInfoOffset) workInner.classList.add("work-single__inner--sticky");
        else workInner.classList.remove("work-single__inner--sticky");
        // Work nav not sticky
        if (scrollPos > footerOffset) workNav.classList.add("work-single__nav--not-sticky");
        else workNav.classList.remove("work-single__nav--not-sticky");
    }
    ...
    window.onscroll = ()=>{
        ...
        sections.forEach((section)=>{
            ...
            if (scrollY >= sectionTop + 200) current = section.getAttribute("data-section");
        });
        navLi.forEach((a)=>{
...
},{}],"3m4Rp":[function(require,module,exports) {
let timeOut;
window.addEventListener("DOMContentLoaded", function() {
    if (document.body.classList.contains("page-template-template-reel")) {
        ...
        document.body.addEventListener("click", function(e) {
            if (e.target.classList.contains("c-button")) return;
